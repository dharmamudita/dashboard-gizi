      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl overflow-hidden h-fit">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <button type="submit" disabled={isSubmitting} className="w-full justify-center rounded-md bg-teal-600 px-3 py-3 text-sm font-bold text-white shadow-sm hover:bg-teal-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-600 disabled:opacity-50 transition-colors">
              {isSubmitting ? 'Mendaftarkan...' : 'Daftarkan Anak ke Database'}
            </button>
          </form>
        </div>
